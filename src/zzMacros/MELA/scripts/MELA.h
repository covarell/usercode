...
pair<double,double> likelihoodDiscriminant (double mZZ, double m1, double m2, double costhetastar, double costheta1, double costheta2, double phi, double phi1, int LHCsqrts, bool withPt = false, double pt = 0.0, bool withY = false, double absy = 0.0, double scaleFactor=5.0);

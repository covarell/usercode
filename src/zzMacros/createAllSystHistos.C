{
  gROOT->ProcessLine(".x studyPtSyst.C(-2,false)");
  gROOT->ProcessLine(".x studyPtSyst.C(-3,false)");
  gROOT->ProcessLine(".x studyPtSyst.C(-5,false)");
  gROOT->ProcessLine(".x studyPtSyst.C(-4,false)");
  gROOT->ProcessLine(".x studyPtSyst.C(1,false)");
  gROOT->ProcessLine(".x studyPtSyst.C(3,false)");
  gROOT->ProcessLine(".x studyPtSyst.C(4,false)");
  gROOT->ProcessLine(".x studyPtSyst.C(5,false)");
  gROOT->ProcessLine(".x studyPtSyst.C(6,false)");
  gROOT->ProcessLine(".x studyPtSyst.C(7,false)");

...
void studyPtOverMsyst(int whichtype = 1, bool also7TeV = true) {
  ...
  // READ TREES
  TChain* ggTree = new TChain("FourLeptonTreeProducer/tree");
  if (also7TeV) {
    ggTree->Add("/scratch0/hep/cmartin/fall12/FromMike/7TeV/ggH125.root");
    ggTree->Add("/scratch0/hep/cmartin/fall12/FromMike/7TeV/ggH126.root");
    //ggTree->Add("../datafiles/2mu2e/HZZ4lTree_H125_105-1000_7TeV_withDiscriminantsPtY.root");
  } else {
    ggTree->Add("/scratch0/hep/cmartin/fall12/FromMike/ggH125.root");
    ggTree->Add("/scratch0/hep/cmartin/fall12/FromMike/ggH126.root");
  }

  TChain* VBFTree = new TChain("FourLeptonTreeProducer/tree");
  if (also7TeV) {
     VBFTree->Add("/scratch0/hep/cmartin/fall12/FromMike/7TeV/qqH125.root");
     VBFTree->Add("/scratch0/hep/cmartin/fall12/FromMike/7TeV/qqH126.root");
  } else {
    VBFTree->Add("/scratch0/hep/cmartin/fall12/FromMike/qqH125.root");
    VBFTree->Add("/scratch0/hep/cmartin/fall12/FromMike/qqH126.root");
  }

  TChain* zzTree = new TChain("FourLeptonTreeProducer/tree");
  if (also7TeV) {
    ...
    zzTree->Add("/scratch0/hep/cmartin/fall12/FromMike/ZZ2e2mu.root");
    zzTree->Add("/scratch0/hep/cmartin/fall12/FromMike/ZZ2e2tau.root");
    zzTree->Add("/scratch0/hep/cmartin/fall12/FromMike/ZZ2mu2tau.root");
    zzTree->Add("/scratch0/hep/cmartin/fall12/FromMike/ZZ4e.root");
    zzTree->Add("/scratch0/hep/cmartin/fall12/FromMike/ZZ4mu.root");
    zzTree->Add("/scratch0/hep/cmartin/fall12/FromMike/ZZ4tau.root");
  }

  TChain* ggzzTree = new TChain("FourLeptonTreeProducer/tree");
  if (also7TeV) {
    ...
    ggzzTree->Add("/scratch0/hep/cmartin/fall12/FromMike/GGZZ2L2L.root");
    ggzzTree->Add("/scratch0/hep/cmartin/fall12/FromMike/GGZZ4L.root");
  }
   
  TChain* dataTree = new TChain("FourLeptonTreeProducer/tree");
  if (also7TeV) {
    ...
    dataTree->Add("/scratch0/hep/cmartin/fall12/FromMike/DATA.root"); 
  }
  ...
  double mgg, mVBF, mzz, mggzz, mdata, mcr, mcros, mzj;
  double wgg, wVBF, wzz, wggzz, wzj;
  double ggeff, VBFeff, zzeff, ggzzeff;
  //float nlogg, nloVBF, nlozz, nloggzz, nlodata, nlocr, nlozj; 
  double ptgg, ptVBF, ptzz, ptggzz, ptdata, ptcr, ptzj;
  int njetsGG, njetsVBF, njetsZZ, njetsGGZZ, njetsDATA;
  double z2_charge,z2_mass,minpairmass;

  ggTree->SetBranchAddress("H_Mass",&mgg);
  ggTree->SetBranchAddress("eventWeight",&wgg);
  ggTree->SetBranchAddress("H_Pt",&ptgg);
  ggTree->SetBranchAddress("H_eff",&ggeff);
  ggTree->SetBranchAddress("H_NJets", &njetsGG);
  //ggTree->SetBranchAddress("melaLDWithPtY",&nlogg);

  VBFTree->SetBranchAddress("H_Mass",&mVBF);
  VBFTree->SetBranchAddress("eventWeight",&wVBF);
  VBFTree->SetBranchAddress("H_Pt",&ptVBF);
  VBFTree->SetBranchAddress("H_eff",&VBFeff);
  VBFTree->SetBranchAddress("H_NJets",&njetsVBF);
  //VBFTree->SetBranchAddress("melaLDWithPtY",&nloVBF);

  zzTree->SetBranchAddress("H_Mass",&mzz);
  zzTree->SetBranchAddress("eventWeight",&wzz);
  zzTree->SetBranchAddress("H_Pt",&ptzz);
  zzTree->SetBranchAddress("H_eff",&zzeff);
  zzTree->SetBranchAddress("H_NJets",&njetsZZ);
  //zzTree->SetBranchAddress("melaLDWithPtY",&nlozz);

  ggzzTree->SetBranchAddress("H_Mass",&mggzz);
  ggzzTree->SetBranchAddress("eventWeight",&wggzz);
  ggzzTree->SetBranchAddress("H_Pt",&ptggzz);
  ggzzTree->SetBranchAddress("H_eff",&ggzzeff);
  ggzzTree->SetBranchAddress("H_NJets",&njetsGGZZ);
  //ggzzTree->SetBranchAddress("melaLDWithPtY",&nloggzz);

  dataTree->SetBranchAddress("HLoose_Mass",&mdata);
  dataTree->SetBranchAddress("HLoose_Pt",&ptdata);
  dataTree->SetBranchAddress("HLoose_NJets",&njetsDATA);
  dataTree->SetBranchAddress("HLoose_MinOSPairMass",&minpairmass);
  dataTree->SetBranchAddress("HLoose_Z2_Mass",&z2_mass);
  dataTree->SetBranchAddress("HLoose_Z2_Charge", &z2_charge);
  ...
  sprintf(nameFile,"old_weightHisto.root");
  ...
  TCanvas can_m("can_m","The canvas for _m",5.,5.,600.,700.); 
  can_m.Divide(1,2);
  ...
  //Extended ranges
  TH1F* pt_mh = new TH1F("pt_mh","pt_m",nbins2,0.,2.);
  TH1F* pt_mh1 = new TH1F("pt_mh1","pt_m",nbins2,0,2.);
  TH1F* pt_mh2 = new TH1F("pt_mh2","pt_m",nbins2,0.,2.);
  TH1F* pt_mvbf = new TH1F("pt_mvbf","pt_m",nbins2,0.,2.);
  pt_mh->Sumw2();
  pt_mh1->Sumw2();
  pt_mh2->Sumw2();
  pt_mvbf->Sumw2();
  ...
  TH1F* pt_malt = new TH1F("pt_malt","pt_m",nbins,binlimits);
  TH1F* pt_malt1 = new TH1F("pt_malt1","pt_m",nbins,binlimits);
  pt_malt->Sumw2();
  pt_malt1->Sumw2();
  ...
  if (whichtype == -5) {
    ...
    TFile* pdfsfile[3];
    pdfsfile[0] = TFile::Open("VBF_standard.root");
    pdfsfile[1] = TFile::Open("VBF_MSTW.root");
    pdfsfile[2] = TFile::Open("VBF_NNPDF.root");
    ...
    for (Int_t iEvt = 0; iEvt < VBFTree->GetEntries() ; ++iEvt) {
      ...
      if (mVBF < 140. && mVBF > 105. && ptVBF < 500. && njetsVBF != 2) {
	int theBin = pdfh[0]->FindBin(ptVBF);
 	pth->Fill(ptVBF,wVBF*VBFeff);
	pth1->Fill(ptVBF,wVBF*VBFeff*ratiopdf[1]->GetBinContent(theBin));
	pth2->Fill(ptVBF,wVBF*VBFeff*ratiopdf[0]->GetBinContent(theBin));

 	pt_mh->Fill((ptVBF/mVBF),wVBF*VBFeff);
	pt_mh1->Fill((ptVBF/mVBF),wVBF*VBFeff*ratiopdf[1]->GetBinContent(theBin));
	pt_mh2->Fill((ptVBF/mVBF),wVBF*VBFeff*ratiopdf[0]->GetBinContent(theBin));
	...
	ptvbf->Fill(ptVBF,wVBF*VBFeff*thisDiff); 
	pt_mvbf->Fill((ptVBF/mVBF),wVBF*VBFeff*thisDiff);
      }
    } 
    ...
    ptvbf->Write();
    pt_mh->SetName("pt_m_H_Default");
    pt_mh->Write();
    pt_mvbf->SetName("pt_m_H_PDF");
    pt_mvbf->Write();
    f1.Close();
  ...
  if (whichtype == -4) {
    ...
    TFile* scalesfile[7];
    scalesfile[0] = TFile::Open("VBF_standard.root");
    scalesfile[1] = TFile::Open("VBF_mufdouble.root");
    scalesfile[2] = TFile::Open("VBF_mufhalf.root");
    scalesfile[3] = TFile::Open("VBF_murdouble.root");
    scalesfile[4] = TFile::Open("VBF_murhalf.root");
    scalesfile[5] = TFile::Open("VBF_mufdouble_murdouble.root");
    scalesfile[6] = TFile::Open("VBF_mufhalf_murhalf.root");
	...
	pt_mh->Fill((ptVBF/mVBF),wVBF*VBFeff);
	pt_mh1->Fill((ptVBF/mVBF),wVBF*VBFeff*ratioscale[1]->GetBinContent(theBin));
	pt_mh2->Fill((ptVBF/mVBF),wVBF*VBFeff*ratioscale[0]->GetBinContent(theBin));
        //nloh->Fill(nloVBF,wVBF);
  ...
  if (whichtype == -3) {
    ...
    can.SaveAs("pt_systTopMass_corr.png");
    sprintf(nameSyst,"TopMass");

    for (Int_t iEvt = 0; iEvt < ggTree->GetEntries() ; ++iEvt) {
      ggTree->GetEntry(iEvt);
      if (mgg < 140. && mgg > 105. && ptgg < 500. && njetsGG != 2) {
	int theBin = wHalf->FindBin(ptgg);
        float newW = 1.;
	// if (ptgg > 90.) 
	newW = ratio->GetBinContent(ratio->FindBin(ptgg));
	pth->Fill(ptgg,wgg*ggeff*wHalf->GetBinContent(theBin));
	pth2->Fill(ptgg,wgg*ggeff*newW*wHalf->GetBinContent(theBin));
	ptvbf->Fill(ptgg,wgg*ggeff*newW*wHalf->GetBinContent(theBin));
	pt_mh->Fill((ptgg/mgg),wgg*ggeff*wHalf->GetBinContent(theBin));
	pt_mh2->Fill((ptgg/mgg),wgg*ggeff*newW*wHalf->GetBinContent(theBin));
	pt_mvbf->Fill((ptgg/mgg),wgg*ggeff*newW*wHalf->GetBinContent(theBin));
  ...
  if (whichtype == -2) {
	...
	// if (ptgg > 90.) 
	newW = ratio->GetBinContent(ratio->FindBin(ptgg));
	pth->Fill(ptgg,wgg*ggeff*newW*wHalf->GetBinContent(theBin));
	pth1->Fill(ptgg,wgg*ggeff*newW*wOne->GetBinContent(theBin));
	pth2->Fill(ptgg,wgg*ggeff*newW*wTwo->GetBinContent(theBin));
	ptvbf->Fill(ptgg,wgg*ggeff*newW*wTwo->GetBinContent(theBin));

	pt_mh->Fill((ptgg/mgg),wgg*ggeff*newW*wHalf->GetBinContent(theBin));
	pt_mh1->Fill((ptgg/mgg),wgg*ggeff*newW*wOne->GetBinContent(theBin));
	pt_mh2->Fill((ptgg/mgg),wgg*ggeff*newW*wTwo->GetBinContent(theBin));
	pt_mvbf->Fill((ptgg/mgg),wgg*ggeff*newW*wTwo->GetBinContent(theBin));
    ...
    pt_mh->SetName("pt_m_H_Default");
    pt_mh->Write();
    pt_mh2->SetName("pt_m_H_Resummation");
    pt_mh2->Write();
    f.Close();
  ...
  if (whichtype == -1) {
	...
	newW = ratio->GetBinContent(ratio->FindBin(ptgg));
	pth->Fill(ptgg,wgg*ggeff*newW*wHalf->GetBinContent(theBin));
	pth1->Fill(ptgg,wgg*ggeff*newW*0.84*wHalf->GetBinContent(theBin));  // gg: +/-16%
	pth2->Fill(ptgg,wgg*ggeff*newW*1.16*wHalf->GetBinContent(theBin));
	ptvbf->Fill(ptgg,wgg*ggeff*newW*1.16*wHalf->GetBinContent(theBin));

	pt_mh->Fill((ptgg/mgg),wgg*ggeff*newW*wHalf->GetBinContent(theBin));
	pt_mh1->Fill((ptgg/mgg),wgg*ggeff*newW*0.84*wHalf->GetBinContent(theBin));  // gg: +/-16%
	pt_mh2->Fill((ptgg/mgg),wgg*ggeff*newW*1.16*wHalf->GetBinContent(theBin));
	pt_mvbf->Fill((ptgg/mgg),wgg*ggeff*newW*1.16*wHalf->GetBinContent(theBin));  
        //nloh->Fill(nlogg,wgg*newW*wHalf->GetBinContent(theBin));
    ...
    for (Int_t iEvt = 0; iEvt < VBFTree->GetEntries() ; ++iEvt) {
      ...
      if (mVBF < 140. && mVBF > 105. && ptVBF < 500. && njetsVBF != 2) {
	pth->Fill(ptVBF,wVBF*VBFeff);
        pth1->Fill(ptVBF,wVBF*VBFeff*1.02);             // VBF: +/-2%
	pth2->Fill(ptVBF,wVBF*VBFeff*0.98);
	ptvbf->Fill(ptVBF,wVBF*VBFeff*0.98);

	pt_mh->Fill((ptVBF/mVBF),wVBF*VBFeff);
        pt_mh1->Fill((ptVBF/mVBF),wVBF*VBFeff*1.02);             // VBF: +/-2%
	pt_mh2->Fill((ptVBF/mVBF),wVBF*VBFeff*0.98);
	pt_mvbf->Fill((ptVBF/mVBF),wVBF*VBFeff*0.98);
        //nloh->Fill(nloVBF,wVBF);
  ...
  if (whichtype == 1) {
	...
	// if (ptgg > 90.) 
	newW = ratio->GetBinContent(ratio->FindBin(ptgg));
	pth1->Fill(ptgg,wgg*ggeff*newW*wHalf->GetBinContent(theBin));
	pt_mh1->Fill((ptgg/mgg),wgg*ggeff*newW*wHalf->GetBinContent(theBin));
    ...
    for (Int_t iEvt = 0; iEvt < VBFTree->GetEntries() ; ++iEvt) {
      VBFTree->GetEntry(iEvt);
      if (mVBF < 140. && mVBF > 105. && ptVBF < 500. && njetsVBF != 2) {
	pth1->Fill(ptVBF,wVBF*VBFeff);
	pt_mh1->Fill((ptVBF/mVBF),wVBF*VBFeff);
        //nloh1->Fill(nloVBF,wVBF);
      }
    }
    ...
    for (Int_t iEvt = 0; iEvt < zzTree->GetEntries() ; ++iEvt) {
      ...
      if (mzz < 140. && mzz > 105. && ptzz < 500. && njetsZZ != 2) {
	pth2->Fill(ptzz,wzz*zzeff);
	ptvbf->Fill(ptzz,wzz*zzeff);

	pt_mh2->Fill((ptzz/mzz),wzz*zzeff);
	pt_mvbf->Fill((ptzz/mzz),wzz*zzeff);
  ...
  if (whichtype == 3) {
    ...
    for (Int_t iEvt = 0; iEvt < zzTree->GetEntries() ; ++iEvt) {
      zzTree->GetEntry(iEvt);
      if (mzz < 140. && mzz > 105. && ptzz < 500. && njetsZZ != 2) {
	pth->Fill(ptzz,wzz*zzeff*(1. + mypol1->Eval(ptzz)));
	pt_mh->Fill((ptzz/mzz),wzz*zzeff*(1. + mypol1->Eval((ptzz/mzz))));
      }
    } 
    ...
    pt_mh->SetName("pt_m_H_UnbRegion");
    pt_mh->Write();
    f2.Close();

    can.SaveAs("pt_systUnbRegion.png");
    //can_m.SaveAs("pt_m_systUnbRegion.png");
    return;
  ...
  if (whichtype == 4) {
    ...
    for (Int_t iBin = 0; iBin < nbins; ++iBin) {
      ...
      pt_malt->SetBinContent(iBin+1,dataSz[iBin]);
      pt_malt->SetBinError(iBin+1,dataErr[iBin]);
      pt_malt1->SetBinContent(iBin+1,powSz[iBin]);
      pt_malt1->SetBinError(iBin+1,powErr[iBin]);
    }
    ...
    pt_malt->SetMarkerColor(1);    pt_malt->SetLineColor(1);    pt_malt->SetLineWidth(2);
    pt_malt1->SetMarkerColor(2);   pt_malt1->SetLineColor(2);   pt_malt1->SetLineWidth(2);
    ...
    can_m.cd(1);
    gPad->SetBottomMargin(0.0);
    pt_malt->GetXaxis()->SetLabelColor(kWhite);
    pt_malt->GetYaxis()->SetTitle("Entries");
    pt_malt->Draw();
    pt_malt1->Draw("SAME");
    ...
    TH1F* diffpt_m = (TH1F*)pt_malt->Clone();
    TH1F* pullpt_m = (TH1F*)pt_malt->Clone();
    diffpt_m->Add(pt_malt,pt_malt1,1,-1);
    pullpt_m->Divide(diffpt_m,pt_malt);
    can_m.cd(2);
    gPad->SetTopMargin(0.0);
    pullpt_m->SetMinimum(-1.);
    pullpt_m->SetMaximum(1.);
    pullpt_m->GetXaxis()->SetLabelColor(kBlack);
    pullpt_m->GetXaxis()->SetTitle("p_{T}/M_{4l}");
    pullpt_m->GetYaxis()->SetTitle("Relative difference");
    pullpt_m->Draw("E");
    TF1 *mypol1 = new TF1("mypol1","pol1");
    pullpt->Fit("mypol1","","");
    ...
    pth->Write();
    pt_mh->SetName("pt_m_H_SingleZ");
    pt_mh->Write();
    f2.Close();

    can.SaveAs("pt_systSingleZ.png");
    can_m.SaveAs("pt_m_systSingleZ.png");
    return;
  }
  ...
  if (whichtype == 5) {
    ...
    for (Int_t iEvt = 0; iEvt < ggzzTree->GetEntries() ; ++iEvt) {
      ...
      if (mggzz < 140. && mggzz > 105. && ptggzz < 500. && njetsGGZZ != 2) {
	pth1->Fill(ptggzz,wggzz*ggzzeff);
	pt_mh1->Fill((ptggzz/mggzz),wggzz*ggzzeff);
        //nloh1->Fill(nloggzz,wggzz);
	pth->Fill(ptggzz,wggzz*ggzzeff);
	pt_mh->Fill((ptggzz/mggzz),wggzz*ggzzeff);
  ...
  if (whichtype == 6) {
    ...
    TFile* pdfsfile[3];
    pdfsfile[0] = TFile::Open("ZZ_standard.root");
    pdfsfile[1] = TFile::Open("ZZ_MSTW.root");
    pdfsfile[2] = TFile::Open("ZZ_NNPDF.root");
	...
	int theBin = pdfh[0]->FindBin(ptzz);
 	pth->Fill(ptzz,wzz);
	pth1->Fill(ptzz,wzz*zzeff*ratiopdf[1]->GetBinContent(theBin));
	pth2->Fill(ptzz,wzz*zzeff*ratiopdf[0]->GetBinContent(theBin));

 	pt_mh->Fill((ptzz/mzz),wzz*zzeff);
	pt_mh1->Fill((ptzz/mzz),wzz*zzeff*ratiopdf[1]->GetBinContent(theBin));
	pt_mh2->Fill((ptzz/mzz),wzz*zzeff*ratiopdf[0]->GetBinContent(theBin));
        //nloh->Fill(nlozz,wzz);
	...
	ptvbf->Fill(ptzz,wzz*zzeff*thisDiff);
	pt_mvbf->Fill((ptzz/mzz),wzz*zzeff*thisDiff);  
      }
    } 
  ...
  if (whichtype == 7) {
    ...
    TFile* scalesfile[7];
    scalesfile[0] = TFile::Open("ZZ_standard.root");
    scalesfile[1] = TFile::Open("ZZ_mufdouble.root");
    scalesfile[2] = TFile::Open("ZZ_mufhalf.root");
    scalesfile[3] = TFile::Open("ZZ_murdouble.root");
    scalesfile[4] = TFile::Open("ZZ_murhalf.root");
    scalesfile[5] = TFile::Open("ZZ_mufdouble_murdouble.root");
    scalesfile[6] = TFile::Open("ZZ_mufhalf_murhalf.root");
	...
	int theBin = scaleh[0]->FindBin(ptzz);
 	pth->Fill(ptzz,wzz*zzeff);
	pth1->Fill(ptzz,wzz*zzeff*ratioscale[1]->GetBinContent(theBin));
	pth2->Fill(ptzz,wzz*zzeff*ratioscale[0]->GetBinContent(theBin));

	pt_mh->Fill((ptzz/mzz),wzz*zzeff);
	pt_mh1->Fill((ptzz/mzz),wzz*zzeff*ratioscale[1]->GetBinContent(theBin));
	pt_mh2->Fill((ptzz/mzz),wzz*zzeff*ratioscale[0]->GetBinContent(theBin));
        //nloh->Fill(nlozz,wzz);
  ...
  pt_mh->Scale(1./pt_mh->Integral());
  pt_mh1->Scale(1./pt_mh1->Integral());
  pt_mh2->Scale(1./pt_mh2->Integral());
  pt_mvbf->Scale(1./pt_mvbf->Integral());
  ...
  pt_mh->SetMarkerColor(1);    pt_mh->SetLineColor(1);    pt_mh->SetLineWidth(2);
  pt_mh1->SetMarkerColor(2);   pt_mh1->SetLineColor(2);   pt_mh1->SetLineWidth(2);
  pt_mh2->SetMarkerColor(4);   pt_mh2->SetLineColor(4);   pt_mh2->SetLineWidth(2);
  ...
  gPad->SetBottomMargin(0.0);
  if (whichtype == -3) gPad->SetLogy();
  pt_mh2->GetXaxis()->SetLabelColor(kWhite);
  pt_mh2->GetYaxis()->SetTitle("Normalized entries");
  pt_mh2->Draw();
  if (whichtype != -3) pt_mh1->Draw("SAME");
  pt_mh->Draw("SAME");
  ...
  sprintf(nameFile,"pt_syst%s.png",nameSyst);
  can.SaveAs(nameFile);

  TH1F* diffpt_m = (TH1F*)pt_mh->Clone();
  TH1F* pullpt_m = (TH1F*)pt_mh->Clone();
  diffpt_m->Add(pt_mvbf,pt_mh,1,-1);
  pullpt_m->Divide(diffpt_m,pt_mh);
  can_m.cd(2);
  gPad->SetTopMargin(0.0);
  pullpt_m->SetMinimum(-1.);
  pullpt_m->SetMaximum(1.);
  ...
  sprintf(nameFile,"pt_m_syst%s.png",nameSyst);
  can_m.SaveAs(nameFile);
  ...
  if (whichtype == 1) {
    ...
    TH1F* balpt_m = (TH1F*)pt_mh->Clone();
    balpt_m->Add(pt_mh2,pt_mh,20.516,4.193);
    balpt_m->Scale(1./balpt_m->Integral());
    ...
    sprintf(nameFile,"pt_balanced%s.png",nameSyst);
    can.SaveAs(nameFile);

    can_m.cd(1);
    gPad->SetBottomMargin(0.0);
    balpt_m->GetXaxis()->SetLabelColor(kWhite);
    balpt_m->GetYaxis()->SetTitle("Normalized entries");
    pt_mh2->Draw();
    balpt_m->Draw("SAME");
    pt_mh1->Draw("SAME");

    diffpt_m->Add(balpt_m,pt_mh2,1,-1);
    pullpt_m->Divide(diffpt_m,pt_mh2);
    can_m.cd(2);
    gPad->SetTopMargin(0.0);
    pullpt_m->SetMinimum(-2.);
    pullpt_m->SetMaximum(2.);
    pullpt_m->Draw("E");
       
    sprintf(nameFile,"pt_m_balanced%s.png",nameSyst);
    can.SaveAs(nameFile);

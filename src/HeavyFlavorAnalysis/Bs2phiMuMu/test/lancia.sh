...
module FEVT = PoolOutputModule { 
    ...
    untracked string fileName = "/home/covarell/home-data06/cmssw/$MYOFILE.root"
...
cd /data06/users/covarell/CMSSW_1_6_12/src/HeavyFlavorAnalysis/Bs2phiMuMu/test
eval \`scramv1 runtime -sh\`
# source /data06/users/covarell/CMSSW_1_6_12/src/HeavyFlavorAnalysis/Bs2phiMuMu/test/patchScramRuntime.sh

cmsRun tmpcfg/$MYIFILE.cfg >& /data06/users/covarell/cmssw/$MYOFILE.log
touch DONE
eof

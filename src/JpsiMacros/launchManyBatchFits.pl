...
foreach $line2 (@log2) {
	...
	# my $currentfit = $fitcommand . ' -p ' . $splitline[0] . ' -l ' . $splitline[1] . ' -r ' . $splitline[2] . ' -y ' . $splitline2[0] .' -d datasets/DataMerged2010_rap' . $splitline2[1] . '.root';
        # my $currentfit = $fitcommand . ' -p ' . $splitline[0] . ' -y ' . $splitline2[0] .' -d datasets/DataMergedWide2010SG_rap' . $splitline2[1] . '.root';
	# my $currentfit = $fitcommand . ' -p ' . $splitline[0] . ' -y ' . $splitline2[0] .' -d datasets/Data2010SG_rap' . $splitline2[1] . '.root';

...
void defineCTResol(RooWorkspace *ws)
{
  ...
  ws->factory("GaussModel::resGNP(Jpsi_Ct,meanResSigW,sigmaResSigNP[0.04,0.01,0.3])");
		    ...
		    RooDataHist *reducedNP, RooDataHist *reducedNPP)
{
  ...
  RooHistPdfConv sigNPNP("sigNPNP","Non-prompt signal with narrow gaussian",*(ws->var("Jpsi_Ct")),*(ws->var("meanResSigW")),*(ws->var("sigmaResSigNP")),*reducedNPP);   ws->import(sigNPNP);
...
int main(int argc, char* argv[]) {
  ...
  if (prefitMass){
    ...
    ws->import(massSim);
    ws->pdf("massSim")->fitTo(*bindata,Extended(1),Minos(0),Save(1),SumW2Error(kTRUE),NumCPU(2));
  ...
  if(prefitSignalCTau){
    ...
    titlestr = "pictures/simtest/2D_" + partFile + "resofitJpsi_pT" + prange + "_y" + yrange + "_Lin.gif";
    c00.SaveAs(titlestr.c_str());
    c00.SetLogy(1); tframePR->Draw();
    titlestr = "pictures/simtest/2D_" + partFile + "resofitJpsi_pT" + prange + "_y" + yrange + "_Log.gif";
    c00.SaveAs(titlestr.c_str());
    ...
    titlestr = "pictures/simtest/2D_" + partFile + "resofitPsip_pT" + prange + "_y" + yrange + "_Lin.gif";
    c00P.SaveAs(titlestr.c_str());
    c00P.SetLogy(1); tframePRP->Draw();
    titlestr = "pictures/simtest/2D_" + partFile + "resofitPsip_pT" + prange + "_y" + yrange + "_Log.gif";
    c00P.SaveAs(titlestr.c_str());
  ...
  if(prefitBackground){
    ...
    ws->import(bkgSim);
    ws->pdf("bkgSim")->fitTo(*reddataSB,SumW2Error(kTRUE));
    ws->var("fpm")->setConstant(kTRUE);
  ...
  if(prefitMass) {
    // RooFitResult *rfr = ws->pdf("totSim")->fitTo(*bindata,Minos(0),Save(1),SumW2Error(kTRUE),NumCPU(4));
    RooFitResult *rfr = ws->pdf("totPDF")->fitTo(*bindataJ,Minos(0),Save(1),SumW2Error(kTRUE),NumCPU(4));
    // ws->var("sigmaResSigN")->setConstant(kTRUE);
    ws->var("fracRes")->setConstant(kTRUE);
    ws->var("sigmaResSigW")->setConstant(kTRUE);
    RooFitResult *rfr2 = ws->pdf("totPDFP")->fitTo(*bindataP,Minos(0),Save(1),SumW2Error(kTRUE),NumCPU(4));
    ...
    RooFitResult *rfr = ws->pdf("totSim")->fitTo(*reddata1,Extended(1),Minos(0),Save(1),SumW2Error(kTRUE),NumCPU(4));
  ...
  TCanvas c1;
  c1.cd();mframe->Draw();
  titlestr = "pictures/simtest/2D_" + partFile + "massfitJpsi_pT" + prange + "_y" + yrange + ".gif";
  ...
  TCanvas c1P;
  c1P.cd();mPframe->Draw();
  titlestr = "pictures/simtest/2D_" + partFile + "massfitPsip_pT" + prange + "_y" + yrange + ".gif";
  ...
  titlestr = "pictures/simtest/2D_" + partFile + "timefitJpsi_pT" + prange + "_y" + yrange + "_Lin.gif";
  c2->SaveAs(titlestr.c_str());
  titlestr = "pictures/simtest/2D_" + partFile + "timefitJpsi_pT" + prange + "_y" + yrange + "_Lin.pdf";
  c2->SaveAs(titlestr.c_str());
  ...
  titlestr = "pictures/simtest/2D_" + partFile + "timefitJpsi_pT" + prange + "_y" + yrange + "_Log.gif";
  c2a->SaveAs(titlestr.c_str());
  titlestr = "pictures/simtest/2D_" + partFile + "timefitJpsi_pT" + prange + "_y" + yrange + "_Log.pdf";
  c2a->SaveAs(titlestr.c_str());
  ...
  c3.cd();
  c3.cd();tframe1->Draw();
  titlestr = "pictures/simtest/2D_" + partFile + "timesideJpsi_pT" + prange + "_y" + yrange + "_Lin.gif";
  c3.SaveAs(titlestr.c_str());
  c3.SetLogy(1);
  c3.cd();tframe1->Draw();
  titlestr = "pictures/simtest/2D_" + partFile + "timesideJpsi_pT" + prange + "_y" + yrange + "_Log.gif";
  c3.SaveAs(titlestr.c_str()); 
  ...
  titlestr = "pictures/simtest/2D_" + partFile + "timefitPsip_pT" + prange + "_y" + yrange + "_Lin.gif";
  c2P->SaveAs(titlestr.c_str());
  titlestr = "pictures/simtest/2D_" + partFile + "timefitPsip_pT" + prange + "_y" + yrange + "_Lin.pdf";
  c2P->SaveAs(titlestr.c_str());
  ...
  titlestr = "pictures/simtest/2D_" + partFile + "timefitPsip_pT" + prange + "_y" + yrange + "_Log.gif";
  c2aP->SaveAs(titlestr.c_str());
  titlestr = "pictures/simtest/2D_" + partFile + "timefitPsip_pT" + prange + "_y" + yrange + "_Log.pdf";
  c2aP->SaveAs(titlestr.c_str());
  ...
  titlestr = "pictures/simtest/2D_" + partFile + "timesidePsip_pT" + prange + "_y" + yrange + "_Lin.gif";
  c3P.SaveAs(titlestr.c_str());
  c3P.SetLogy(1);
  c3P.cd();tframeP1->Draw();
  titlestr = "pictures/simtest/2D_" + partFile + "timesidePsip_pT" + prange + "_y" + yrange + "_Log.gif";
  c3P.SaveAs(titlestr.c_str()); 
  ...
  char oFile[200];
  sprintf(oFile,"results/simtest/results2D%s_pT%s_y%s.txt",partFile.c_str(),prange.c_str(),yrange.c_str());

...
process.bTagValidation = cms.EDAnalyzer("myBTagAnalyzerMC",
    ...
    tagConfig = cms.PSet(
        ...
        tagInfoLabel1 = cms.InputTag("impactParameterTagInfos"),
        tagInfoLabel2 = cms.InputTag("secondaryVertexTagInfos"),
        tagInfoLabel3 = cms.InputTag("ghostTrackVertexTagInfos"),  
        tagLabel = cms.InputTag("combinedSecondaryVertexBJetTags")
    ), 
